 ...
 * @access public
 */
class Modern_Fashion_Store_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'modern-fashion-store';
...
class Modern_Fashion_Store_Button extends WP_Customize_Section {
