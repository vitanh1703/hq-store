 ...
 */
/** Range Control */
class Modern_Fashion_Store_Range_Slider extends WP_Customize_Control {
    /**
    ...
    public function enqueue() {
        wp_enqueue_style( 'modern_fashion_store-range-control-styles', get_parent_theme_file_uri( '/assets/css/controls/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'modern_fashion_store-range-control-scripts', get_parent_theme_file_uri( '/assets/js/controls/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
